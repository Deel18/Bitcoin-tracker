...
def get_btc_price():
    '''Function for requesting the current price'''
...
def send_message(chat_id, msg):
    '''Function for sending a message through telegram'''
...
def main():
    ...
    while True:
        ...
        #If the price tanks below given limit send a message
        if price['price'] < limit:
            send_message(chat_id=chat_id, msg=f'BTC Price Drop Alert: {price["price"]}')

        #Send message and format to make more readable
